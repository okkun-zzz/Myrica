...
# set font name
newfontM  = ("../Work/MyricaMM.ttf", "MyricaMM", "MyricaM M", "MyricaM Monospace")
newfontP  = ("../Work/MyricaMP.ttf", "MyricaMP", "MyricaM P", "MyricaM Proportional")
newfontN  = ("../Work/MyricaMN.ttf", "MyricaMN", "MyricaM N", "MyricaM Narrow")
